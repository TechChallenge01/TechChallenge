...
namespace Infra.Migrations
{
    ...
    [Migration("20260503234519_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.EstoqueAggregates.EstoqueHistorico", b =>
                {
                    ...
                    b.HasIndex("EstoqueId1")
                        .IsUnique()
                        .HasFilter("[EstoqueId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Aggregates.EstoqueAggregates.EstoqueHistorico", b =>
                {
                    ...
                    b.HasOne("Domain.Aggregates.EstoqueAggregates.Estoque", null)
                        .WithOne("HistoqueHistorico")
                        .HasForeignKey("Domain.Aggregates.EstoqueAggregates.EstoqueHistorico", "EstoqueId1");
            ...
            modelBuilder.Entity("Domain.Aggregates.EstoqueAggregates.Estoque", b =>
                {
                    b.Navigation("HistoqueHistorico")
                        .IsRequired();
