...
public class OsPecaEntity : Base.BaseEntity
{
    ...
    public OsPecaEntity(Guid osId, Guid pecaId, int quantidade, decimal valorUnitario, Guid idUsuarioCriacao)
    {
