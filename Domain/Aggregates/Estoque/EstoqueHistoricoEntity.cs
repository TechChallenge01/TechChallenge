...
public class EstoqueHistoricoEntity : Base.BaseEntity
{
    ...
    public EstoqueHistoricoEntity(Guid estoqueId, int quantidade, string observacao, ETipoMovimentacao tipoMovimentacao, Guid UsuarioCriacaoId, DateTime dataCriacao) : base(UsuarioCriacaoId, dataCriacao, null, null)
    {
    ...
    protected EstoqueHistoricoEntity() { }
