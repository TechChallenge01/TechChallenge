...
namespace Application.UseCases.OrdensServicos
{
    public class CancelarOrdemServicoUseCase
    {
        ...
        private CancelarOrdemServicoUseCase(OrdemServicoGateway ordemServicoGateway, PecaGateway pecaGateway, InsumoGateway insumogateway, EstoqueGateway estoqueGateway)
        {
        ...
        public static CancelarOrdemServicoUseCase Create(OrdemServicoGateway ordemServicoGateway, PecaGateway pecaGateway, InsumoGateway insumogateway, EstoqueGateway estoqueGateway)
        {
            return new CancelarOrdemServicoUseCase(ordemServicoGateway, pecaGateway, insumogateway, estoqueGateway);
        }
