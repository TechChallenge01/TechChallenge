...
public interface IServicoService
{
    ...
    Task<ICommandResult<Guid>> Create(ServicoRequestDTO request,Guid idUsuario, CancellationToken ct);
    Task<ICommandResult> Delete(Guid Id, Guid idUsuario, CancellationToken ct);
    Task<ICommandResult> Update(Guid Id, Guid idUsuario, ServicoRequestDTO request, CancellationToken ct);
